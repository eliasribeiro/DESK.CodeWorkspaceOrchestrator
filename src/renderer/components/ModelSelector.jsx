  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        ...
        >
          <div className="p-3 border-b border-border-light dark:border-white/5">
          ...
          {/* Footer */}
          <div className="px-4 py-2 border-t border-border-light dark:border-white/5
                          bg-surface-light dark:bg-background-dark/50">
            <p className="text-xs text-slate-500 dark:text-slate-400">
